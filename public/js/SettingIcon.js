                          ...
                          <Form.Group
                            ...
                            <Form.Check size='sm'>
                              <Form.Check.Input
                                ...
                                checked={
                                  configuration.buy.automaticBuyAmount.enabled
                                }
                                onChange={this.handleInputChange}
                              />
                              <Form.Check.Label>
                          ...
                          <Form.Group
                            ...
                            <Form.Check size='sm'>
                              <Form.Check.Input
                                ...
                                checked={
                                  configuration.buy.automaticBuyAmount
                                    .drainWallet
                                }
                                disabled={
                                  !configuration.buy.automaticBuyAmount.enabled
                                      ...
                                      <Form.Group
                                        ...
                                        <Form.Check size='sm'>
                                          <Form.Check.Input
                                            ...
                                            checked={
                                              configuration.buy.aggressiveMode
                                                .enabled
                                            }
                                            onChange={this.handleInputChange}
                                          />
                                            ...
                                            <OverlayTrigger
                                              ...
                                              overlay={
                                                <Popover id='buy-aggressive-mode-enabled-overlay-right'>
                                                  <Popover.Content>
                                                    If enabled, the bot will
                                                    place larger buy orders by
                                                    multiplying the purchase
                                                    amount defined in your grid
                                                    trade configuration by the
                                                    factor set for each market
                                          ...
                                          <OverlayTrigger
                                            ...
                                            overlay={
                                              <Popover id='aggressive-mode-when-strong-buy-right'>
                                                <Popover.Content>
                                                  Set the factor for increasing
                                                  the grid purchase amount if
                                                  TradingView recommendation is
                                                  'Strong buy'. Note the
                                                  resulting amount might be
                                                  higher than your grid maximum
                                                  purchase amount. Setting to
                                                  1.20 will increase the amount
                                                  by 20%.
                                                </Popover.Content>
                                              </Popover>
                                            }>
                                            ...
                                            overlay={
                                              <Popover id='aggressive-mode-when-buy-right'>
                                                <Popover.Content>
                                                  ...
                                                  the grid purchase amount if
                                                  TradingView recommendation is
                                                  'Buy'. Note the resulting
                                                  amount might be higher than
                                                  your grid maximum purchase
                                                  amount. Setting to 1.10 will
