                                ...
                                <div className='col-12'>
                                  <Form.Group
                                    ...
                                    <Form.Check size='sm'>
                                      ...
                                      />
                                      <Form.Check.Label>
                                        Kagi Buy Restriction Enabled - only for
                                        grids with at least one executed buy
                                        trade{' '}
                                        <OverlayTrigger
                                          trigger='click'
                                          ...
                                          overlay={
                                            <Popover id='buy-kagi-restriction-enabled-overlay-right'>
                                              <Popover.Content>
                                                If enabled, the bot buys if the
                                                Kagi signal is bullish on the
                                                last 2 candles. This increases
                                                the chance to buy right after a
                                      ...
                                      <Form.Group
                                        ...
                                        <Form.Check size='sm'>
                                          ...
                                          <Form.Check.Label>
                                            ...
                                            <OverlayTrigger
                                              trigger='click'
                                              key='sell-stop-loss-enabled-onlyLastGridTrade'
                                              placement='bottom'
                                              overlay={
                                                <Popover id='sell-stop-loss-onlyLastGridTrade-overlay-right'>
                                                  <Popover.Content>
                                                    If enabled, stop-loss can
